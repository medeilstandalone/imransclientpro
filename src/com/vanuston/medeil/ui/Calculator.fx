...
import  com.vanuston.medeil.util.FXCalc;
...
public var focused:Boolean;
    ...
    var key = bind CommonDeclare.currKyEvent on replace {
      if(show==1 and CommonDeclare.MainPageForm.equals("Calculator")){
       FXCalc.KeyPressed(key);
    }}
    ...
    var panelLX = (panelW - 218) / 2;
    var panelLY = (panelH - 278) / 2;
